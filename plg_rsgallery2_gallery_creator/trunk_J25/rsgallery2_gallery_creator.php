...
class plgUserRsgallery2_gallery_creator extends JPlugin
{
	...
	public function onUserAfterSave($user, $isnew, $success, $msg)
	{
		...
		if ($isnew) {
			...
			// How to handle the asset/permissions? Todo (now asset from parent is used automaticaaly)
			// Asset example:
			...
			// Perhaps check if the user owns a gallery, if not, create it?
		}
	}

	/**
	 * Does nothing (yet): perhaps do something with the user's gallery after the user is deleted?
	 *
