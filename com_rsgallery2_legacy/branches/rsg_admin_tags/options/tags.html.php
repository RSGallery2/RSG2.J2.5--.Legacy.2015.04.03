...
class html_rsg2_tags{
    ...
    function show( &$rows, &$lists, &$search, &$pageNav ){
        ...
        <tr>
			...
			<th width="2%"><?php echo _RSGALLERY_TAGS_ORDER?></th>
			<th width="2%">
        ...
        for ($i=0, $n=count( $rows ); $i < $n; $i++) {
            ...
            <tr class="<?php echo "row$k"; ?>">
                ...
                if ( $row->checked_out && ( $row->checked_out != $my->id ) ) {
                    ...
                    ?>
                    <a href="<?php echo $link; ?>" name="Edit Tag">
                    <?php echo $row->name;; ?>                    </a>
                    <?php
                }
                ?>                </td>
                ...
                <img src="images/<?php echo $img;?>" width="12" height="12"  alt="<?php echo $alt; ?>" />                </a>                </td>
                <td>
                <?php echo $pageNav->orderUpIcon( $i ); ?>                </td>
                <td>
