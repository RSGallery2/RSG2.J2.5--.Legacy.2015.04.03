...
DEFINE("_RSGALLERY_USERIMAGE_NOTOWNER",		"Nem Te vagy a tulajdonosa ennek a képnek, visszairányítunk a fõoldalra");
...
DEFINE("_RSGALLERY_MAX_USERCAT_ALERT",		"Már létrehoztad az engedélyezett számú galériát, visszairányítunk a fõoldalra");
...
DEFINE("_RSGALLERY_BATCH_FTP_PATH_OVERL",	"Gyõzõdj meg róla, hogy az FTP útvonal a webgyökéren belül található. Nem lehet másik kiszolgálón! Továbbá legyen perjel a végén.");
//function editImage
...
//function viewImages
DEFINE("_RSGALLERY_NO_PREVIEW ",		    "A képet nem tekintheted meg elõnézetben");
...
DEFINE("_RSGALLERY_SEL_TO_DEL",		"Jelöld ki a törlendõ elemeket a listában");
DEFINE("_RSGALLERY_SURE_DEL",		"Biztosan törölni akarod a kijelölt elemeket? ");
DEFINE("_RSGALLERY_SEL_TO_MOVE",		"Jelöld ki az áthelyezendõ elemeket a listában");
...
DEFINE("_RSGALLERY_CONSDB_NOTICE",	"&nbsp;<span style='text-size: 14px;font-weight:bold;'>MEGJEGYZÉS</span>:<br />Az Összevonás adatbázissal funkció majdnem mûködik. Hozzáadásra került az 'Adatbázisbejegyzés létrehozása' funkció is.<br />Ügyelj azonban arra, hogy egyszerre több bejegyzést nem adhatsz hozzá az adatbázishoz. Mostantól egyenként kell hozzáadnod õket!");
...
DEFINE("_RSGALLERY_CONSDB_IMG_IN_FLDR",		"A mappában lévõ kép");
DEFINE("_RSGALLERY_CONSDB_IMG__NOT_IN_FLDR",		"NEM a mappában lévõ kép");
DEFINE("_RSGALLERY_ ",		"");
...
DEFINE("_RSGALLERY_INSTALL_SUCCESS",		"Sikerült!  Most már a következõ verziót használod: RSGallery2 ");
...
DEFINE("_RSGALLERY_C_TMPL_INTRO_TEXT",		"Bevezetõ:");
...
DEFINE("_RSGALLERY_C_TMPL_DISP_ITEMS",		"A galériában lévõ tételek számának megjelenítése");
...
DEFINE("_RSGALLERY_COMMENTS_ONLY_ONCE",		"Egy felhasználó csak egyszer nyilváníthat véleményt a képrõl");
...
DEFINE("_RSGALLERY_VOTE_COOKIE_PREFIX",		"A cookie elõtagja");


//galleries.class.php
//function check
DEFINE("_RSGALLERY_GAL_EXIST_ERROR",		"Már van ilyen nevû galéria. Kérjük, hogy próbálkozz újra.");
...
DEFINE("_RSGALLERY_PERMS_NOT_EXIST",				" Nem létezik. Kérjük, hogy FTP-n hozd létre kézzel, és ellenõrizd az engedélyeket");
...
DEFINE("_RSGALLERY_INSTALL_STATUS_MSGS",			"Ha van valamilyen figyelemre méltó állapotüzenet, akkor kérjük, hogy tekintsd meg, mielõtt felkeresed a kezelõpultot.");
//function deleteTable
DEFINE("_RSGALLERY_TABLEDEL_OK",					" törlése megtörtént");
DEFINE("_RSGALLERY_TABLEDEL_NOTOK",				" nem törölhetõ.<br />Töröld kézzel.");
...
DEFINE("_RSGALLERY_MIGRATE_ZOOM_OK",		"a Zoom Gallery áttelepítése befejezõdött. Keresd fel a kezelõpultot.");
...
DEFINE("_RSGALLERY_UPGRADE_THUMB_TRANF_ERROR",		"Hibák merültek föl a bélyegképfájlok új szerkezetbe történõ átvitelekor.<br />Kérjük, hogy FTP-n keresztül ellenõrizd.");
DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE",		"A megjelenített képek létrehozása sikerült.");
DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE_ERROR",		"Nem sikerült létrehozni néhány vagy az összes megjelenített képet.<br />Lépj kapcsolatba a komponens fejlesztõivel.");
...
DEFINE("_RSGALLERY_IMG_NO_FILE_SELECT",		"Egy fájlt sem jelöltél ki egy vagy több mezõben.");/*javascript alert*/
...
DEFINE("_RSGALLERY_FU_IMAGE_TO",		" kép a következõ mappába: ");
...
//function handleFTP
DEFINE("_RSGALLERY_FU_FTP_DIR_NOT_EXIST",		" nem létezik, vagy nem könyvtár az Ön kiszolgálóján. Ellenõrozze az elérési utat.");
DEFINE("_RSGALLERY_FU_NO_VALID_IMG",		"Nem található érvényes kép a(z) ");
DEFINE("_RSGALLERY_FU_PLEASE_CHECK_PATH",		"könyvárban. Ellenõrizd az elérési utat.");
...
DEFINE("_RSGALLERY_FU_MAX_FILESIZE_FORM",		"A feltöltött fájl mérete túllépi a HTML ûrlapban megadott MAX_FILE_SIZE utasítás által engedélyezettet.");
...
DEFINE("_RSGALLERY_FU_UPL_STOP_EXT",		"A bõvítmény leállította a fájl feltöltését");
...
DEFINE("_RSGALLERY_COMMENTS_SEC_IMG_MISS", "Az adminisztrációban engedélyezték a SecurityImages bõvítményt, viszont nem történt meg a komponens telepítése! Értesítsd a webmestert");
DEFINE("_RSGALLERY_COMMENTS_NOCOMM",	"Még senki sem írta meg a véleményét errõl a képrõl!");
...
/*double deleted DEFINE("_RSGALLERY_COMMENTS_ONLY_ONCE",		"Csak egyszer nyilváníthatsz véleményt errõl a képrõl!");*/
DEFINE("_RSGALLERY_COMMENTS_INCORRECT_CAPTCHA",		"Helytelen CAPTCHA ellenõrzés, a véleményedet NEM mentettük!");
...
DEFINE("_RSGALLERY_TEMPLATES_AUTHOR",	"Szerzõ");
DEFINE("_RSGALLERY_TEMPLATES_VERSION",	"Verzió");
DEFINE("_RSGALLERY_TEMPLATES_DATE",	"Dátum");
DEFINE("_RSGALLERY_TEMPLATES_AUTH_URL",	"A szerzõ weblapja");
