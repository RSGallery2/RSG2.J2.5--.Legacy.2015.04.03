...
* Usage example: {rsg2_singledisplay:9999,thumb,true,left;float:left} 
*/
...
/**
 * Code to replace {rsg2_singledisplay: imageid, size, caption, align}
 *
	...
	if( $matches ) {
		...
		if ( (int)$clean_attribs[0] ) {
			...
			if ( isset( $clean_attribs[2] ) ) {
				...
				$image_caption = bot_rsg2_singledisplay_bool($clean_attribs[2]);
			} else {
				$image_caption = NULL;
			}
