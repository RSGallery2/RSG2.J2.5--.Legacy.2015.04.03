...
* @version 1.14.1 alpha created on January 25, 2008
* @package RSGallery2
...
//rsgallery2.html.php
//RSShowPictures
DEFINE("_RSGALLERY_MAGIC_NOTIMP",		"A varázslat még megvalósításra vár");
//showMyGalleries
DEFINE("_RSGALLERY_FEAT_NOTIMP",		"A funkció megvalósításra vár");
...
/*moved DEFINE("_RSGALLERY_COMMENT_DELETE",			"Biztosan törölni akarod ezt a véleményt?");*/
...
DEFINE("_RSGALLERY_MYGAL_NOT_AUTH",		"Jogosulatlan hozzáférési kísérlet történt a Galériáimhoz!");
//function save_image
...
DEFINE("_RSGALLERY_USERIMAGE_NOTOWNER",		"Nem Te vagy a tulajdonosa ennek a képnek, visszairányítunk a főoldalra");
...
DEFINE("_RSGALLERY_MAX_USERCAT_ALERT",		"Már létrehoztad az engedélyezett számú galériát, visszairányítunk a főoldalra");
...
/*new*/DEFINE("_RSGALLERY_C_MAINTENANCE",	"Karbantartás");
...
DEFINE("_RSGALLERY_BATCH_FTP_PATH_OVERL",	"Győződj meg róla, hogy az FTP útvonal a webgyökéren belül található. Nem lehet másik kiszolgálón! Továbbá legyen perjel a végén.");
//function editImage
...
DEFINE("_RSGALLERY_CONF_OPTION_PROP",		"Arányos");
DEFINE("_RSGALLERY_CONF_OPTION_SQUARE",		"NÉGYZET");
DEFINE("_RSGALLERY_CONF_OPTION_DEFAULT_SIZE",		"Alapértelmezett méret");
...
/*new*/DEFINE("_RSGALLERY_CONF_POPUP_LIGHTBOX",		"Lightbox++ előugró");
//function showconfig
...
DEFINE("_RSGALLERY_SEL_TO_DEL",		"Jelöld ki a törlendő elemeket a listában");
DEFINE("_RSGALLERY_SURE_DEL",		"Biztosan törölni akarod a kijelölt elemeket? ");
DEFINE("_RSGALLERY_SEL_TO_MOVE",		"Jelöld ki az áthelyezendő elemeket a listában");
DEFINE("_RSGALLERY_SEL_GAL_TO_MOVE",	"Válaszd ki a listából azt a galériát, melybe át kívánod helyezni a képeket");
DEFINE("_RSGALLERY_SURE_MOVE",		"Biztosan át akarod helyezni a kijelölt elemeket?");
...
DEFINE("_RSGALLERY_CONSDB_NOTICE",	"&nbsp;<span style='text-size: 14px;font-weight:bold;'>MEGJEGYZÉS</span>:<br />Az Összevonás adatbázissal funkció majdnem működik. Hozzáadásra került az 'Adatbázisbejegyzés létrehozása' funkció is.<br />Ügyelj azonban arra, hogy egyszerre több bejegyzést nem adhatsz hozzá az adatbázishoz. Mostantól egyenként kell hozzáadnod őket!");
...
DEFINE("_RSGALLERY_HEAD_UPLOAD_ZIP",		"ZIP fájl feltöltése");
DEFINE("_RSGALLERY_HEAD_CONSDB",		"Adatbázis egyesítése");
DEFINE("_RSGALLERY_HEAD_LOG",		"Fejlesztési napló");
DEFINE("_RSGALLERY_HEAD_CONF_VARIA",		"Konfigurációs változók");
DEFINE("_RSGALLERY_HEAD_CONF_RAW_EDIT",		"Beállítások nyers módosítása");
DEFINE("_RSGALLERY_HEAD_MISS_IMG_CREATE",	"A hiányzó képek létrehozása kész");
...
//function db_create
DEFINE("_RSGALLERY_DB_CREATE_NO_GAL",		"Nem választottad ki a galériát, melybe a képeket kívánod helyezni!");
...
//function toString
DEFINE("_RSGALLERY_CONF_ERROR_UPLOAD",		" - Képfeltöltési hiba : ");
//function showCategories
DEFINE("_RSGALLERY_SELECT_GAL_DROP_BOX",		"- Válassz galériát -");
...
/*NEW*/DEFINE("_RSGALLERY_C_TMPL_DISP_OWNER",		"A tulajdonos adatainak megjelenítése");
/*NEW*/DEFINE("_RSGALLERY_C_TMPL_DISP_ITEMS",		"A galériában lévő tételek számának megjelenítése");
/*NEW*/DEFINE("_RSGALLERY_C_TMPL_DISP_DATE",		"A létrehozás dátumának megjelenítése");
...
DEFINE("_RSGALLERY_C_TMPL_SHOW_MYGAL",		"A Galériáim megjelenítése");
...
/*NEW*/DEFINE("_RSGALLERY_C_DISP_IMG_ORDER",		"Képek sorrendje");
/*NEW*/DEFINE("_RSGALLERY_C_DISP_IMG_ORDER_BY",		"Képek rendezése");
/*NEW*/DEFINE("_RSGALLERY_C_DISP_IMG_ORDER_DIRECTION",		"Rendezés iránya");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_DEFAULT",		"Alapértelmezett");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_DATE",		"Dátum");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_NAME",		"Név");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_RATING",		"Értékelés");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_HITS",		"Találatok");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_DIRECTION_ASCENDING",		"Növekvő");
/*NEW*/DEFINE("_RSGALLERY_CONF_OPTION_ORDER_DIRECTION_DESCENDING",		"Csökkenő");
...
//galleries.class.php
//function check
DEFINE("_RSGALLERY_GAL_EXIST_ERROR",		"Már van ilyen nevű galéria. Kérjük, hogy próbálkozz újra.");
...
DEFINE("_RSGALLERY_GAL_PARAMETERS",		"Paraméterek");
DEFINE("_RSGALLERY_GAL_OWNER",	"Tulajdonos");
DEFINE("_RSGALLERY_GAL_PERMS",	"Engedélyek");
DEFINE("_RSGALLERY_GAL_DEF_PERM_CREATE",	"Az alapértelmezett engedélyek létrehozása kész. <br />A galéria létrehozása után térhetsz vissza a galéria engedélyeinek módosításához.");
DEFINE("_RSGALLERY_GAL_NO_PERM_FOUND",	"Nem találhatók ennek a galériának az engedélyei. Kattints a <strong>MENTÉS</strong> gombra a fenti eszköztáron az alapértelmezett engedélyek létrehozásához. Ezután térj vissza ide, és állítsd be az engedélyeket.");
DEFINE("_RSGALLERY_GAL_USERTYPE",		"Felhasználótípus");
DEFINE("_RSGALLERY_GAL_VIEW_GAL",		"Galéria<br/>megtekintése</span>");
DEFINE("_RSGALLERY_GAL_UPL_EDIT_IMG",	"Képek<br/>feltöltése/szerkesztése</span>");
DEFINE("_RSGALLERY_GAL_DEL_IMG",			"Kép törlése</span>");
DEFINE("_RSGALLERY_GAL_MOD_GAL",			"Galéria<br/>módosítása</span>");
DEFINE("_RSGALLERY_GAL_DEL_GAL",			"Galéria<br/>törlése</span>");
/*new*/DEFINE("_RSGALLERY_GAL_VOTE_VIEW",			"Szavazatok<br/>Megtekintése</span>");
/*new*/DEFINE("_RSGALLERY_GAL_VOTE_VOTE",			"Szavazat<br/>Leadása</span>");
DEFINE("_RSGALLERY_GAL_ACL_PUB",			"Mindenki</span>");
DEFINE("_RSGALLERY_GAL_ACL_REG",			"Regisztráltak</span>");
DEFINE("_RSGALLERY_GAL_SEL_DESEL_ALL",	"&nbsp;Az összes kijelölése/kijelölés megszüntetése");
...
DEFINE("_RSGALLERY_INSTALL_NOT_CREATED",			" létrehozása nem sikerült");
//function createTableStructure
DEFINE("_RSGALLERY_ISNTALL_DB_OK",				"Az adatbázistáblák létrehozása sikerült.");
//function copyFiles
DEFINE("_RSGALLERY_INSTALL_FILE_COPY_FROM",		"Sikerült a fájl másolása innen: ");
...
DEFINE("_RSGALLERY_PERMS_NOT_EXIST",				" Nem létezik. Kérjük, hogy FTP-n hozd létre kézzel, és ellenőrizd az engedélyeket");
...
DEFINE("_RSGALLERY_PERMS_NOT_SET_TRY_FTP",		".<br />Kérjük, hogy FTP-n keresztül próbáld meg módosítani ezeket az engedélyeket.");
...
DEFINE("_RSGALLERY_INSTALL_STATUS_MSGS",			"Ha van valamilyen figyelemre méltó állapotüzenet, akkor kérjük, hogy tekintsd meg, mielőtt felkeresed a kezelőpultot.");
//function deleteTable
DEFINE("_RSGALLERY_TABLEDEL_OK",					" törlése megtörtént");
DEFINE("_RSGALLERY_TABLEDEL_NOTOK",				" nem törölhető.<br />Töröld kézzel.");
...
DEFINE("_RSGALLERY_MIGRATE_ENTRIES_OK",		" bejegyzés feldolgozva)");
DEFINE("_RSGALLERY_MIGRATE_ALL",				"Az összes fájlinformáció áttelepítése sikerült az RSGallery2 adatbázisba(");
...
DEFINE("_RSGALLERY_MIGRATE_ZOOM_OK",		"a Zoom Gallery áttelepítése befejeződött. Keresd fel a kezelőpultot.");
...
DEFINE("_RSGALLERY_UPGRADE_THUMB_TRANF_ERROR",		"Hibák merültek föl a bélyegképfájlok új szerkezetbe történő átvitelekor.<br />Kérjük, hogy FTP-n keresztül ellenőrizd.");
DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE",		"A megjelenített képek létrehozása sikerült.");
DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE_ERROR",		"Nem sikerült létrehozni néhány vagy az összes megjelenített képet.<br />Lépj kapcsolatba a komponens fejlesztőivel.");
...
DEFINE("_RSGALLERY_MIGRATION_NO_SYSTEMS",		"Nincs más galériarendszer telepítve");
//function doMigration
DEFINE("_RSGALLERY_MIGRATION_NOT_VALID",		"nem érvényes áttelepítési típus.");

//uninstall.rsgallery2.php
//function com_uninstall
DEFINE("_RSGALLERY_UNINSTALL_OK",		"Az eltávolítás sikerült");
...
DEFINE("_RSGALLERY_IMG_SELECT_GAL",			"Ki kell választanod egy galériát.");/*javascript alert*/
DEFINE("_RSGALLERY_IMG_NO_FILE_SELECT",		"Egy fájlt sem jelöltél ki egy vagy több mezőben.");/*javascript alert*/
...
DEFINE("_RSGALLERY_IMG_GEN_DESCR",			"Általános leírás");
DEFINE("_RSGALLERY_IMG_IMG_FILES",			"Képfájlok");
DEFINE("_RSGALLERY_IMG_IMAGES",			"Képek");
DEFINE("_RSGALLERY_IMG_FILE",			"Fájl");
DEFINE("_RSGALLERY_IMG_MORE",			"(több kép)");
...
/*new*/DEFINE("_RSGALLERY_TMPL_GAL_SUBGALLERIES",	"Algalériák: ");
/*new*/DEFINE("_RSGALLERY_TMPL_GAL_UPLOADED",	"Feltöltve");
...
DEFINE("_RSGALLERY_FU_PLEASE_CHECK_PATH",		"könyvárban. Ellenőrizd az elérési utat.");
...
/*new*/DEFINE("_RSGALLERY_COMMENTS_COLOR",	"-szín-");
/*new*/DEFINE("_RSGALLERY_COMMENTS_AQUA",	"cián");
/*new*/DEFINE("_RSGALLERY_COMMENTS_BLACK",	"fekete");
/*new*/DEFINE("_RSGALLERY_COMMENTS_BLUE",	"kék");
/*new*/DEFINE("_RSGALLERY_COMMENTS_FUCHSIA",	"lila");
/*new*/DEFINE("_RSGALLERY_COMMENTS_GRAY",	"szürke");
/*new*/DEFINE("_RSGALLERY_COMMENTS_GREEN",	"zöld");
/*new*/DEFINE("_RSGALLERY_COMMENTS_LIME",	"zöld");
/*new*/DEFINE("_RSGALLERY_COMMENTS_MAROON",	"sötétvörös");
/*new*/DEFINE("_RSGALLERY_COMMENTS_NAVY",	"sötétkék");
/*new*/DEFINE("_RSGALLERY_COMMENTS_OLIVE",	"okkersárga");
/*new*/DEFINE("_RSGALLERY_COMMENTS_PURPLE",	"sötétlila");
/*new*/DEFINE("_RSGALLERY_COMMENTS_RED",	"piros");
/*new*/DEFINE("_RSGALLERY_COMMENTS_SILVER",	"ezüst");
/*new*/DEFINE("_RSGALLERY_COMMENTS_TEAL",	"sötétcián");
/*new*/DEFINE("_RSGALLERY_COMMENTS_WHITE",	"fehér");
/*new*/DEFINE("_RSGALLERY_COMMENTS_YELLOW",	"sárga");
/*new*/DEFINE("_RSGALLERY_COMMENTS_SIZE",	"-méret-");
/*new*/DEFINE("_RSGALLERY_COMMENTS_TINY",	"nagyon kicsi");
/*new*/DEFINE("_RSGALLERY_COMMENTS_SMALL",	"kicsi");
/*new*/DEFINE("_RSGALLERY_COMMENTS_MEDIUM",	"közepes");
/*new*/DEFINE("_RSGALLERY_COMMENTS_LARGE",	"nagy");
/*new*/DEFINE("_RSGALLERY_COMMENTS_HUGE",	"nagyon nagy");
//function parseQuoteElement
/*new*/DEFINE("_RSGALLERY_COMMENTS_QUOTE_WROTE", "Írta");
//function editComment
/*moved*/DEFINE("_RSGALLERY_COMMENT_ADD",		"Vélemény");
/*moved*/DEFINE("_RSGALLERY_COMMENT_NAME",		"Név");
/*moved*/DEFINE("_RSGALLERY_COMMENTS_TITLE",		"Cím");
/*moved*/DEFINE("_RSGALLERY_COMMENT_COMMENT",		"A vélemény szövege");
//function showComments
/*moved*/DEFINE("_RSGALLERY_COMMENT_DELETE",	"Biztosan törölni akarod a véleményt?");
/*moved*/DEFINE("_RSGALLERY_COMMENTS",	"Vélemények");
/*new*/DEFINE("_RSGALLERY_COMMENTS_NUM_COMM_ADD",	"Beküldött vélemények #");
/*new*/DEFINE("_RSGALLERY_DELETE_COMMENT",			"Vélemény törlése");
/*new*/DEFINE("_RSGALLERY_COMMENTS_SEC_IMG_MISS", "Az adminisztrációban engedélyezték a SecurityImages bővítményt, viszont nem történt meg a komponens telepítése! Értesítsd a webmestert");
/*new*/DEFINE("_RSGALLERY_COMMENTS_NOCOMM",	"Még senki sem írta meg a véleményét erről a képről!");

//rsgcomments.php
/*new*/DEFINE("_RSGALLERY_COMMENTS_COMMDEL",		"A vélemény törlése sikerült");
...
/*new*/DEFINE("_RSGALLERY_TPL_INST",	"Új RSGTemplate <small><small>[ Webhely ]</small></small> telepítése");
...
//rsgsearch.html.php
/*new*/DEFINE("_RSGALLERY_SEARCH_RESULTS_TITLE",	"RSGallery2 Keresés Eredménye");
/*new*/DEFINE("_RSGALLERY_SEARCH_RESULTS_NUMBER1",	"Összesen ");
/*new*/DEFINE("_RSGALLERY_SEARCH_RESULTS_NUMBER2",	" találat van: ");
/*new*/DEFINE("_RSGALLERY_SEARCH_LABEL",			"Keresés");
/*new*/DEFINE("_RSGALLERY_SEARCH_KEYWORDS",			"Keresés...");

//maintenance.html.php
/*new*/DEFINE("_RSGALLERY_MAINT_HEADER",	"Karbantarás");
/*new*/DEFINE("_RSGALLERY_MAINT_CONSOLDB",	"Adatbázis Ellenőrzése");
/*new*/DEFINE("_RSGALLERY_MAINT_CONSOLDB_TXT",	"Ez az opció ellenőrzi az RSGallery tábláit az adatbázisban, és a fizikai képfájlokat az esetleges hibák után kutatva.");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN",	"Bélyegképek újragenerálása");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_TXT",	"Ez az opció újragenerálja a bélyegképeket. Hasznos, ha nemrég módosítottuk azok méretét a beállításokban.");
/*new*/DEFINE("_RSGALLERY_MAINT_OPTDB",	"Adatbázis Optimalizálása");
/*new*/DEFINE("_RSGALLERY_MAINT_OPTDB_TXT",	"Az RSGallery2 tábláinak ellenőrzése és optimalizálása.");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_BUTTON",	"Újragenerálás");
/*new*/DEFINE("_RSGALLERY_MAINT_OPTIMIZE_SUCCESS",	"A táblák optimalizációja sikeres volt.");
/*new*/DEFINE("_RSGALLERY_MAINT_NO_GALLERY_SELECTED",	"Nem választottál ki galériát!");
/*new*/DEFINE("_RSGALLERY_MAINT_NO_THUMBSIZE_CHANGE",	"A bélyegképek mérete nem változott, nincs szükség az újragenerálásra.");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_ERRORS",	"Hiba az újragenerálás közben. Ellenőrizd a bélyegképeket.");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_NO_ERRORS",	"A regenerálás befejeződött.");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_ONLY_THUMB",	"Csak a bélyegkép elérhető, így más képet nem generálhatsz!");
/*new*/DEFINE("_RSGALLERY_MAINT_REGEN_SUCCESS",	" sikeresen létrehozva");
