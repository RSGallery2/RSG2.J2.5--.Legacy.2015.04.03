...
/*new*/DEFINE("_RSGALLERY_CONF_POPUP_FANCY",		"Süslü açýlýr pencereFancy popup (IE6! içerisinde hatalar)");
...
DEFINE("_RSGALLERY_REAL_UNINST_DIR",		"JPATH_SITE/images/rsgallery kaldýrma sýnamasý için rm -r kullanýldý");
