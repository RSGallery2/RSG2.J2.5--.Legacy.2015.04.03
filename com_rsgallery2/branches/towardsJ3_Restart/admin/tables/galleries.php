...
class rsg2TableGalleries extends JTable {
    ...
    */
    ...
    function check() {
        ...
        if (trim( $this->name ) == '') {
            $this->_error = JText::_('COM_RSG2_GALLERY_NAME');
            return false;
        }
        ...
        if ($xid && $xid != intval( $this->id )) {
            $this->_error = JText::_('COM_RSG2_THERE_IS_A_GALLERY_ALREADY_WITH_THAT_NAME_PLEASE_TRY_AGAIN');
            return false;
        }
	...
	protected function _getAssetName() {
		$k = $this->_tbl_key;
		return 'com_rsg2.gallery.'.(int) $this->$k;
	}
