...
class HTML_RSGALLERY{
    ...
    function showUserGalleryX($rows)
    {
                ...
                <td align="right">
                    ...
                    <tr height="60" valign="middle" align="center">
                        <td>
                            ...
                            <img src="<?php echo $mosConfig_live_site;?>/images/save_f2.png"  alt="Save" name="save" title="Save" align="middle" /></a>
                        </td>
                        <td>
                            <a class="toolbar" href="javascript:submitbutton2('cancel');" >
                            <img src="<?php echo $mosConfig_live_site;?>/images/cancel_f2.png"  alt="Cancel" name="cancel" title="Cancel" align="middle"  /></a>
                        </td>
                    </tr>
                    </table>
                    </div>
     ...
     * @param integer pagenav stuff
     */
    function RSShowPicturesX($catid, $limit, $limitstart){
    ...
    function showMyGalleriesX($rows) {
     ...
     */
    function showMyImagesX($images, $pageNav) {
     ...
     */
     ...
     function RSGalleryUserInfoX($id) {
     global $my, $rsgConfig;
    ...
    function myGalleriesX($rows, $images, $pageNav)
        {
