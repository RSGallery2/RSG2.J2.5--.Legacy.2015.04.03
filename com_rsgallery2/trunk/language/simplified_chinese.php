...
DEFINE("_RSGALLERY_CREATE_GALLERY",			"建立图库");
DEFINE("_RSGALLERY_SAVE",					"保存");
DEFINE("_RSGALLERY_CANCEL",					"取消");
DEFINE("_RSGALLERY_CATLEVEL",				"顶层图库");
DEFINE("_RSGALLERY_USERCAT_NAME",			"图库名称");
DEFINE("_RSGALLERY_DESCR",					"描述");
DEFINE("_RSGALLERY_CATPUBLISHED",			"已发布");
//function edit_image
DEFINE("_RSGALLERY_EDIT_IMAGE",				"编辑图片");
DEFINE("_RSGALLERY_CAT_NAME",				"分类名称");
DEFINE("_RSGALLERY_EDIT_FILENAME",			"文件名称");
DEFINE("_RSGALLERY_EDIT_TITLE",			    "标题");
DEFINE("_RSGALLERY_EDIT_DESCRIPTION",		"描述");
//function showFrontUpload
DEFINE("_RSGALLERY_UPLOAD_ALERT_CAT",		"你必须选择图库.");
DEFINE("_RSGALLERY_UPLOAD_ALERT_FILE",		"你必须提供上传文件.");
DEFINE("_RSGALLERY_ADD_IMAGE",				"新增图片");
DEFINE("_RSGALLERY_USERUPLOAD_TITLE",		"用户上传");
DEFINE("_RSGALLERY_USERUPLOAD_CATEGORY",	"图库");
DEFINE("_RSGALLERY_FILENAME",				"文件名称");
DEFINE("_RSGALLERY_UPLOAD_FORM_TITLE",		"标题");
DEFINE("_RSGALLERY_UPLOAD_THUMB",			"缩略图:");
//function RSGalleryInline
DEFINE("_RSGALLERY_COMMENT_DELETE",			"你确定要删除此评论?");
DEFINE("_RSGALLERY_NOIMG",					"图库内没有图片");
DEFINE("_RSGALLERY_SLIDESHOW",		        "幻灯片显示");
DEFINE("_RSGALLERY_CATHITS",				"点击数");
DEFINE("_RSGALLERY_NODESCR",				"没有描述");
DEFINE("_RSGALLERY_VOTING",					"评分");
DEFINE("_RSGALLERY_VOTES_NR",				"评分");
DEFINE("_RSGALLERY_VOTES_AVG",				"平均评分");
DEFINE("_RSGALLERY_NO_RATINGS",				"尚未有评分!");
DEFINE("_RSGALLERY_VOTE",			   		"评分");
...
DEFINE("_RSGALLERY_COMMENTS",			   	"评论");
DEFINE("_RSGALLERY_NO_COMMENTS",			"尚未有评论!");
DEFINE("_RSGALLERY_COMMENT_DATE",   		"日期");
DEFINE("_RSGALLERY_COMMENT_BY",     		"来自");
DEFINE("_RSGALLERY_COMMENT_TEXT",   		"评论");
DEFINE("_RSGALLERY_DELETE_COMMENT",			"删除评论");
DEFINE("_RSGALLERY_COMMENT_ADD",			"新增评论");
DEFINE("_RSGALLERY_COMMENT_NAME",   		"你的名称");
DEFINE("_RSGALLERY_COMMENT_ADD_TEXT",   	"你的评论");
DEFINE("_RSGALLERY_EXIF",					"EXIF");
//function RSGalleryTitleblock
DEFINE("_RSGALLERY_MAIN_GALLERY_PAGE",		"图库主页");
DEFINE("_RSGALLERY_MY_GALLERIES",			"我的图库");
DEFINE("_RSGALLERY_SLIDESHOW_EXIT",			"离开幻灯片显示");
DEFINE("_RSGALLERY_COMPONENT_TITLE",		"图库");
//function subGalleryList
DEFINE("_RSGALLERY_IMAGES",					" 图片");
DEFINE("_RSGALLERY_SUB_GALLERIES",			"子图库:");
//function RSGalleryList
//function RSShowPictures
DEFINE("_RSGALLERY_DELIMAGE_TEXT",			"你确定要删除此图片吗?");
//function showMyGalleries
DEFINE("_RSGALLERY_USER_MY_GAL",			"我的图库");
DEFINE("_RSGALLERY_MY_IMAGES_CATEGORY",		"图库");
DEFINE("_RSGALLERY_MY_IMAGES_PUBLISHED",	"已发布");
DEFINE("_RSGALLERY_MY_IMAGES_DELETE",		"删除");
DEFINE("_RSGALLERY_MY_IMAGES_EDIT",			"编辑");
DEFINE("_RSGALLERY_MY_IMAGES_PERMISSIONS",	"权限");
DEFINE("_RSGALLERY_NO_USER_GAL",			"没有已建立的用户图库");
DEFINE("_RSGALLERY_DELCAT_TEXT",			"你确定要删除此图库吗?\\n如果此图库仍存有图片, 它们将会一同被删除.");
//function showMyImages
DEFINE("_RSGALLERY_MY_IMAGES",				"我的图片");
DEFINE("_RSGALLERY_MY_IMAGES_NAME",			"名称");
DEFINE("_RSGALLERY_NOIMG_USER",				"用户图库中没有图片");
//function RSGalleryUserInfo
DEFINE("_RSGALLERY_USER_INFO",				"用户资料");
DEFINE("_RSGALLERY_USER_INFO_NAME",			"用户名称");
DEFINE("_RSGALLERY_USER_INFO_ACL",			"用户级别");
DEFINE("_RSGALLERY_USER_INFO_MAX_GAL",		"最大用户图库数目");
...
//function showLatest
DEFINE("_RSGALLERY_LATEST_TITLE",			"最新图片");
...
DEFINE("_RSGALLERY_DELIMAGE_NOID",			"没有提供 Id. 请联系本组件开发人员");
//function addVote
DEFINE("_RSGALLERY_THANK_VOTING",			"多谢你的评分");
DEFINE("_RSGALLERY_VOTING_FAILED",			"你的评分失败");
//function deleteComment
DEFINE("_RSGALLERY_COMMENT_DELETED",		"评论已成功删除!");
DEFINE("_RSGALLERY_COMMENT_NOT_DELETED",	"评论不能被删除");
//function addComment
DEFINE("_RSGALLERY_COMMENT_FIELD_CHECK",	"请输入名称及/或评论!");
DEFINE("_RSGALLERY_COMMENT_ADDED",			"评论已成功新增!");
DEFINE("_RSGALLERY_COMMENT_NOT_ADDED",		"评论未能新增!");
//function makeusercat
DEFINE("_RSGALLERY_ALERT_CATDETAILSOK",		"图库细节已更新!");
DEFINE("_RSGALLERY_ALERT_CATDETAILSNOTOK",	"不能更新图库细节!");
DEFINE("_RSGALLERY_MAX_USERCAT_ALERT",		"已达最大图库数目, 你将会被带回主画面");
DEFINE("_RSGALLERY_ALERT_NEWCAT",			"新图库已建立!");
DEFINE("_RSGALLERY_ALERT_NONEWCAT",			"图库不能建立!\\n你将会被带回前一个画面.");
//function delUserCat
DEFINE("_RSGALLERY_USERCAT_SUBCATS",        "此图库包含子分类及不能被删除. 如果你想删除此图库, 先移动或删除子分类");
DEFINE("_RSGALLERY_ALERT_CATDELNOTOK",		"图库不能被删除!");
DEFINE("_RSGALLERY_ALERT_CATDELOK",			"图库已删除!");
//function doFrontUpload
DEFINE("_RSGALLERY_MAX_USERIMAGES_ALERT",   "已达最大上传图片数目. 先删除一些图片.");
DEFINE("_RSGALLERY_BATCH_ERROR_SIZE",		"上传的 ZIP 压缩包过大. 你的上传限制(已定义于 php.ini) 是 ");
DEFINE("_RSGALLERY_ALERT_UPLOADOK",			"图片已成功上传!");
DEFINE("_RSGALLERY_ALERT_NOWRITE",			"上传失败.\\n返回到上传画面");
DEFINE("_RSGALLERY_ALERT_WRONGFORMAT",		"错误的图片格式.\\n你将会重新指向到上传画面");

//admin.rsgallery2.html.php
DEFINE("_RSGALLERY_TAB_GALLERIES",			"图库");
DEFINE("_RSGALLERY_MOST_RECENT_GAL",		"最近新增图库");
DEFINE("_RSGALLERY_GALLERY",				"图库");
DEFINE("_RSGALLERY_USER",					"用户");
DEFINE("_RSGALLERY_ID",						"ID");
DEFINE("_RSGALLERY_TAB_IMAGES",				"图片");
DEFINE("_RSGALLERY_MOST_RECENT_IMG", 		"最近新增图片");
...
DEFINE("_RSGALLERY_C_UPLOAD_ZIP",			"批量上传");
DEFINE("_RSGALLERY_C_IMAGES",				"管理图片");
DEFINE("_RSGALLERY_C_CATEGORIES",			"管理图库");
DEFINE("_RSGALLERY_C_DATABASE",				"统一数据库");
DEFINE("_RSGALLERY_C_MIGRATION",			"迁移选项");
DEFINE("_RSGALLERY_C_CSS_EDIT",				"编辑 CSS");
DEFINE("_RSGALLERY_C_DEBUG_ON",				"高级除错选项.  除错模式是在 <a href='index2.php?option=com_rsgallery2&task=showConfig'>配置</a>设定。");
DEFINE("_RSGALLERY_C_PURGE",				"消除/删除全部");
DEFINE("_RSGALLERY_C_REALLY_UNINSTALL",		"真的要删除 - 删除所有图片, 目录, 删除所有资料表. 只适合在有预设目录的 Linux.");
DEFINE("_RSGALLERY_C_VIEW_CONFIG",			"设定 - 查看");
DEFINE("_RSGALLERY_C_EDIT_CONFIG",			"设定 - Raw 编辑");
//function requestCatCreation
DEFINE("_RSGALLERY_C_CAT_FIRST",			"先建立目录!");
//function batch_upload
DEFINE("_RSGALLERY_BATCH_NO_ZIP",			"已选取 ZIP 上传但没有选择文件");
DEFINE("_RSGALLERY_BATCH_GAL_FIRST",		"请先选择目录");
DEFINE("_RSGALLERY_BATCH_NO_FTP",			"已选取 FTP 上传但没有提供 FTP 路径");
DEFINE("_RSGALLERY_BATCH_STEP1",			"步骤 1");
DEFINE("_RSGALLERY_BATCH_METHOD",			"指定上传模式");
DEFINE("_RSGALLERY_BATCH_METHOD_TIP",		"选择要上传单一文件, ZIP 压缩包或上传完整目录");
DEFINE("_RSGALLERY_BATCH_ZIPFILE",			"ZIP 压缩包");
DEFINE("_RSGALLERY_BATCH_UPLOAD_LIMIT",		"上传限制是 ");
DEFINE("_RSGALLERY_BATCH_IN_PHPINI",		" Mb (设定于 php.ini)");
DEFINE("_RSGALLERY_BATCH_FTP_PATH",			"FTP 路径");
DEFINE("_RSGALLERY_BATCH_DONT_FORGET_SLASH","(别忘记开始及结尾斜线)");
DEFINE("_RSGALLERY_BATCH_CATEGORY",			"指定图库");
...
DEFINE("_RSGALLERY_BATCH_STEP2",			"步骤 2");
...
//function viewImages
DEFINE("_RSGALLERY_DELETE",					"删除");
DEFINE("_RSGALLERY_MOVETO",					"移动到");
DEFINE("_RSGALLERY_NUMDISPLAY",				"显示 #");
DEFINE("_RSGALLERY_SEARCH",					"搜索");
DEFINE("_RSGALLERY_IMAGENAME",				"名称");
DEFINE("_RSGALLERY_IMAGEFILE",				"文件名称");
DEFINE("_RSGALLERY_IMAGECAT",				"图库");
...
DEFINE("_RSGALLERY_CONSDB_ORIG",			"原相<br>资料夹");
DEFINE("_RSGALLERY_CONSDB_THUMB",			"缩略图<br>资料夹");
DEFINE("_RSGALLERY_CONSDB_ACT",				"行动");
DEFINE("_RSGALLERY_CONSDB_DELETE_DB",		"[&nbsp;从数据库删除&nbsp;]");
DEFINE("_RSGALLERY_CONSDB_CREATE_IMG",		"[&nbsp;建立缺失图片&nbsp;]");
...
DEFINE("_RSGALLERY_CONF_CREATE_DIR",		"建立图片目录尚未实施.");
//function RSInstall
DEFINE("_RSGALLERY_MIGR_OK",				"成功迁移");
//function purgeEverything
DEFINE("_RSGALLERY_PURGE_IMG",				"已从数据库消除图片纪录.");
DEFINE("_RSGALLERY_PURGE_GAL",				"已从数据库消除图库.");
...
DEFINE("_RSGALLERY_REAL_UNINST_DROP_COM",	"已删除 #__rsgallery2_comments");
DEFINE("_RSGALLERY_REAL_UNINST_DONE",		"完成.  如出现错误请手动移除以上全部.  你应该立即删除 RSGallery2 否则你将会收到错误.");
//function deleteImage
DEFINE("_RSGALLERY_ALERT_IMGDELETEOK",		"已成功删除图片!");
//function c_delete
DEFINE("_RSGALLERY_ALERT_IMGDELETENOTOK",	"图片没有被删除!");
//function save_batchupload
DEFINE("_RSGALLERY_ALERT_NOCATSELECTED",	"请为所有图片选择图库!\\n(也为将会被删除的图片.\\nn这将会于未来版本修正!)");
DEFINE("_RSGALLERY_ZIP_TO_BIG",				"ZIP-压缩包太大!");
//function myPreExtractCallBack
DEFINE("_RSGALLERY_NOT_ALLOWED_FILETYPE",	"是不被允许的文件类型, 它将会被删除!");
DEFINE("_RSGALLERY_BATCH_ERROR_FTP1",		"你所选取的目录并不存在.\\n 你将会被带回上传画面.");
//function showUpload
DEFINE("_RSGALLEY_ALERT_REST_UPLOADOK",		"余下的文件已被上传");
//function saveImage
DEFINE("_RSGALLERY_ALERT_IMAGEDETAILSOK",	"成功更新细节!");
DEFINE("_RSGALLERY_ALERT_IMAGEDETAILSNOTOK","细节没有被更新!");
//function showConfig
DEFINE("_RSGALLERY_CONF_NOGD2",				"未能检测到 GD2");
DEFINE("_RSAGALLERY_CONF_NOIMGMAGICK",		"未能检测到 ImageMagick");
DEFINE("_RSAGALLERY_CONF_NONETPBM",			"未能检测到 netPBM");
//function viewImages
DEFINE("_RSGALLERY_VIEW_GAL",				"查看图库");
DEFINE("_RSGALLERY_ALL_GAL",				"- 所有图库");
DEFINE("_RSGALLERY_SELECT_GAL",				"选择图库");
//function consolidateDbInform
DEFINE("_RSGALLERY_CONSOLIDATE_DB",
"「统一数据库」函数会执行比对在 RSGallery 数据库中的资料表以及相关的实体图片".
" 在图库目录中的文件, 如果有不一致的情形将会输出列表出来.  用户将可".
" 从选项新增或删除数据库纪录或实体图片文件以保持图库的".
" 一致性.<br/><br/>如果有任何的新增或删除图档,".
"  都应该利用这个函数.  例如. 一个用户可以 FTP 新增图片到图库目录".
" 然后执行此函数去更新数据库.<br/><br/>请在下面选择 '继续' 或 '取消'.  在".
" 确认前不会作出任何变更.<br/>");
DEFINE("_RSGALLERY_PROCEED",				"继续");
//function editTemplateCSS
DEFINE("_RSGALLERY_EDITCSS_FAIL_NOOPEN",	"运行失败: 不能开启");
DEFINE("_RSGALLERY_EDITCSS_NOT_WRITABLE",	"运行失败: 文件不能写入.");
DEFINE("_RSGALLERY_EDITCSS_FAIL_NOTWRITING","运行失败: 开启文件写入时失败.");
//function editCSSSource
DEFINE("_RSGALLERY_EDITCSS_TITLE",			"RSgallery2 CSS 编辑器");
DEFINE("_RSGALLERY_ISWRITABLE",				"RSgallery2.css 是 :");
DEFINE("_RSGALLERY_ISWRITABLE_WRITABLE",	"可以写入");
DEFINE("_RSGALLERY_ISWRITABLE_UNWRITABLE",	"不能写入");
DEFINE("_RSGALLERY_MAKE_WRITABLE",			"保存后变更为不可写入");
...
DEFINE("_RSGALLERY_FOLDER_NOTEXIST",		" 并不存在! 请建立此资料夹及确定你 CHMOD 资料夹到 0755!");
DEFINE("_RSGALLERY_ERROR_SETTINGS",			"以下设定令 RSGallery2 不能正常运作:");
...
DEFINE("_RSGALLERY_MIGRATING_FROM",			"迁移到 RSGallery2 ");
DEFINE("_RSGALLERY_INSTALL_SUCCESS",		"成功.  现在使用 RSGallery2 ");
DEFINE("_RSGALLERY_INSTALL_FAIL",			"失败: ");

//toolbar.rsgallery2.html.php
DEFINE("_RSGALLERY_TOOL_CLOSE",				"关闭");
DEFINE("_RSGALLERY_TOOL_PANEL",				"控制面板");
DEFINE("_RSGALLERY_TOOL_GAL",				"图库");
DEFINE("_RSGALLERY_TOOL_IMG",				"图片");
...
DEFINE("_RSGALLERY_C_TMPL_INTRO_TEXT",		"介绍文字:");
DEFINE("_RSGALLERY_C_TMPL_DEBUG",			"除错:");
DEFINE("_RSGALLERY_C_TMPL_IMG_MANIP",		"操作图片");
DEFINE("_RSGALLERY_C_TMPL_DISP_WIDTH",		"显示图片宽度:");
DEFINE("_RSGALLERY_C_TMPL_THUMB_WIDTH",		"缩略图宽度:");
DEFINE("_RSGALLERY_C_TMPL_THUMBNAIL_STYLE",		"缩略图样式:");
DEFINE("_RSGALLERY_C_TMPL_JPEG_QUALITY",	"JPEG 品质百分比");
DEFINE("_RSGALLERY_C_TMPL_GRAPH_LIB",		"图像库");
DEFINE("_RSGALLERY_C_TMPL_NOTE_GLIB_PATH",	"注意:</span> 除非出现问题否则留空以下栏位.");
DEFINE("_RSGALLERY_C_TMPL_IMGMAGICK_PATH",	"ImageMagick 路径:");
DEFINE("_RSGALLERY_C_TMPL_NETPBM_PATH",		"Netpbm 路径:");
DEFINE("_RSGALLERY_C_TMPL_FTP_PATH",		"FTP 路径:");
DEFINE("_RSGALLERY_C_TMPL_IMG_STORAGE",		"图片保存");
DEFINE("_RSGALLERY_C_TMPL_KEEP_ORIG",		"缩略原图片:");
DEFINE("_RSGALLERY_C_TMPL_ORIG_PATH",		"原图片路径:");
DEFINE("_RSGALLERY_C_TMPL_DISP_PATH",		"显示图片路径:");
DEFINE("_RSGALLERY_C_TMPL_THUMB_PATH",		"缩略图路径:");
DEFINE("_RSGALLERY_C_TMPL_CREATE_DIR",		"如目录不存就建立:");
DEFINE("_RSGALLERY_C_TMPL_FRONT_PAGE",		"首页");
DEFINE("_RSGALLERY_C_TMPL_DISP_RAND",		"显示随机");
DEFINE("_RSGALLERY_C_TMPL_DISP_LATEST",		"显示最新");
DEFINE("_RSGALLERY_C_TMPL_DISP_BRAND",		"显示商标");
DEFINE("_RSGALLERY_C_TMPL_DISP_DOWN",		"显示下载链接");
DEFINE("_RSGALLERY_C_TMPL_WATERMARK",		"图片水印 ");
DEFINE("_RSGALLERY_C_TMPL_DISP_WTRMRK",		"显示水印");
DEFINE("_RSGALLERY_C_TMPL_WTRMRK_TEXT",		"水印文字");
DEFINE("_RSGALLERY_C_TMPL_WTRMRK_FONTSIZE",	"水印字体大小e");
DEFINE("_RSGALLERY_C_TMPL_WTRMRK_ANGLE",	"水印文字角度");
DEFINE("_RSGALLERY_C_TMPL_WTRMRK_POS",		"水印位置");
DEFINE("_RSGALLERY_C_TMPL_GAL_VIEW",		"图库查看");
DEFINE("_RSGALLERY_C_TMPL_THUMB_STYLE",		"缩略图风格:<br>可变宽度的主题布景请使用浮动.");
DEFINE("_RSGALLERY_C_TMPL_FLOATDIRECTION",	"方向 (只适用于浮动):");
DEFINE("_RSGALLERY_C_TMPL_COLS_PERPAGE",	"缩略图列数 (只适用于表格):");
DEFINE("_RSGALLERY_C_TMPL_THUMBS_PERPAGE",	"每页缩略图数目:");
DEFINE("_RSGALLERY_C_TMPL_DISP_SLIDE",		"显示幻灯片显示");
DEFINE("_RSGALLERY_C_TMPL_IMG_DISP",		"图片显示");
DEFINE("_RSGALLERY_C_TMPL_RESIZE_OPT",		"重设大小选项");
DEFINE("_RSGALLERY_C_TMPL_DISP_DESCR",		"显示描述");
DEFINE("_RSGALLERY_C_TMPL_DISP_HITS",		"显示点击数");
DEFINE("_RSGALLERY_C_TMPL_DISP_VOTE",		"显示评分");
DEFINE("_RSGALLERY_C_TMPL_DISP_COMM",		"显示评论");
DEFINE("_RSGALLERY_C_TMPL_DISP_EXIF",		"显示 EXIF 资料");
DEFINE("_RSGALLERY_C_TMPL_ENABLE_U_UP",		"启动用户上传?");
DEFINE("_RSGALLERY_C_TMPL_ONLY_REGISTERED",	"只限注册用户");
