...
DEFINE("_RSGALLERY_INSTALL_SUCCESS",		"Sikerült!  Most már a következő verziót használja: RSGallery2 ");
...
DEFINE("_RSGALLERY_COMMENTS_SEC_IMG_MISS", "Az adminisztrációban engedélyezték a SecurityImages bővítményt, viszont nem történt meg a komponens telepítése! Értesítse a webmestert");
...
/*double deleted DEFINE("_RSGALLERY_COMMENTS_ONLY_ONCE",		"Csak egyszer nyilváníthat véleményt erről a képről!");*/
DEFINE("_RSGALLERY_COMMENTS_INCORRECT_CAPTCHA",		"Helytelen CAPTCHA ellenőrzés, a véleményét NEM mentettük!");
