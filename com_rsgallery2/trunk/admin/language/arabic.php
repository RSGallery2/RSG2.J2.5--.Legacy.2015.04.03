...
DEFINE("_RSGALLERY_MAKECAT_ALERT_NAME",		"íÌÈ ÅÏÎÇá ÇÓã ÇáãÚÑÖ.");
DEFINE("_RSGALLERY_MAKECAT_ALERT_DESCR",	"íÌÈ ÅÏÎÇá æÕÝ ÇáãÚÑÖ.");
DEFINE("_RSGALLERY_CREATE_GALLERY",			"ÅäÔÇÁ ãÚÑÖ");
DEFINE("_RSGALLERY_SAVE",					"ÍÝÙ");
DEFINE("_RSGALLERY_CANCEL",					"ÅáÛÇÁ ÇáÃ/Ñ");
DEFINE("_RSGALLERY_CATLEVEL",				"ÇáãÚÑÖ ÇáÃÚáì");
DEFINE("_RSGALLERY_USERCAT_NAME",			"ÇÓã ÇáãÚÑÖ");
DEFINE("_RSGALLERY_DESCR",					"ÇáæÕÝ");
DEFINE("_RSGALLERY_CATPUBLISHED",			"ãäÔæÑ");
//function edit_image
DEFINE("_RSGALLERY_EDIT_IMAGE",				"ÊÚÏíá ÇáÕæÑÉ");
DEFINE("_RSGALLERY_CAT_NAME",				"ÇÓã ÇáÊÕäíÝ");
DEFINE("_RSGALLERY_EDIT_FILENAME",			"ÇÓã ÇáãáÝ");
DEFINE("_RSGALLERY_EDIT_TITLE",			    "ÇáÚäæÇä");
DEFINE("_RSGALLERY_EDIT_DESCRIPTION",		"ÇáæÕÝ");
//function showFrontUpload
DEFINE("_RSGALLERY_UPLOAD_ALERT_CAT",		"íÌÈ ÊÍÏíÏ ãÚÑÖ.");
DEFINE("_RSGALLERY_UPLOAD_ALERT_FILE",		"You must provide a file to upload.");
DEFINE("_RSGALLERY_ADD_IMAGE",				"ÅÖÇÝÉ ÕæÑÉ");
DEFINE("_RSGALLERY_USERUPLOAD_TITLE",		"ÊÍãíá ÇáãÓÊÎÏã");
DEFINE("_RSGALLERY_USERUPLOAD_CATEGORY",	"ãÚÑÖ");
DEFINE("_RSGALLERY_FILENAME",				"ÇÓã ÇáãáÝ");
DEFINE("_RSGALLERY_UPLOAD_FORM_TITLE",		"ÇáÚäæÇä");
...
DEFINE("_RSGALLERY_NOIMG",					"áÇíæÌÏ ÕæÑ Ýí åÐÇ ÇáÚãÑÖ");
DEFINE("_RSGALLERY_SLIDESHOW",		        "ÚÑÖ ãÓÊãÑ");
DEFINE("_RSGALLERY_CATHITS",				"ÒíÇÑÇÊ");
DEFINE("_RSGALLERY_NODESCR",				"áÇíæÌÏ æÕÝ");
DEFINE("_RSGALLERY_VOTING",					"ÊÕæíÝ");
DEFINE("_RSGALLERY_VOTES_NR",				"ÃÕæÇÊ");
DEFINE("_RSGALLERY_VOTES_AVG",				"ÇáãÚÏá ÇáæÓØí ááÃÕæÇÊ");
DEFINE("_RSGALLERY_NO_RATINGS",				"áÇíæÌÏ ÊÞííã ÍÊì ÇáÂä!");
DEFINE("_RSGALLERY_VOTE",			   		"ÕæÊ");
DEFINE("_RSGALLERY_VERYGOOD",				"&nbsp;ÌíÏ ÌÏÇ&nbsp;");
DEFINE("_RSGALLERY_GOOD",					"&nbsp;ÌíÏ&nbsp;");
DEFINE("_RSGALLERY_OK",					    "&nbsp;ãÞÈæá&nbsp;");
DEFINE("_RSGALLERY_BAD",					"&nbsp;ÓíÁ&nbsp;");
DEFINE("_RSGALLERY_VERYBAD",				"&nbsp;ÓíÁ ÌÏÇ&nbsp;");
DEFINE("_RSGALLERY_COMMENTS",			   	"ÊÚáíÞÇÊ");
DEFINE("_RSGALLERY_NO_COMMENTS",			"áÇÊÚáíÞ ÍÊì ÇáÂä!");
DEFINE("_RSGALLERY_COMMENT_DATE",   		"ÇáÊÇÑíÎ");
DEFINE("_RSGALLERY_COMMENT_BY",     		"ãä ÞÈá");
DEFINE("_RSGALLERY_COMMENT_TEXT",   		"ÊÚáíÞ");
DEFINE("_RSGALLERY_DELETE_COMMENT",			"ÍÐÝ ÊÚáíÞ");
DEFINE("_RSGALLERY_COMMENT_ADD",			"ÅÖÇÝÉ ÊÚáíÞ");
DEFINE("_RSGALLERY_COMMENT_NAME",   		"ÇÓãß");
DEFINE("_RSGALLERY_COMMENT_ADD_TEXT",   	"ÊÚáíÞß");
DEFINE("_RSGALLERY_EXIF",					"EXIF");
//function RSGalleryTitleblock
DEFINE("_RSGALLERY_MAIN_GALLERY_PAGE",		"ÕÝÍÉ ÇáãÚÑÖ ÇáÑÆíÓí");
DEFINE("_RSGALLERY_MY_GALLERIES",			"ãÚÇÑÖí");
DEFINE("_RSGALLERY_SLIDESHOW_EXIT",			"ÅäåÇÁ ÇáÚÑÖ");
DEFINE("_RSGALLERY_COMPONENT_TITLE",		"ÇáãÚÑÖ");
//function subGalleryList
DEFINE("_RSGALLERY_IMAGES",					" ÇáÕæÑ");
DEFINE("_RSGALLERY_SUB_GALLERIES",			"ãÚÑÖ ÝÑÚí:");
//function RSGalleryList
//function RSShowPictures
DEFINE("_RSGALLERY_DELIMAGE_TEXT"			,"åá ÇäÊ ãÊÇßÏ ãä ÍÐÝ åÐå ÇáÕæÑÉ?");
//function showMyGalleries
DEFINE("_RSGALLERY_USER_MY_GAL",			"ãÚÇÑÖí");
DEFINE("_RSGALLERY_MY_IMAGES_CATEGORY",		"ãÚÑÖ");
DEFINE("_RSGALLERY_MY_IMAGES_PUBLISHED",	"ãäÔæÑ");
DEFINE("_RSGALLERY_MY_IMAGES_DELETE",		"ÍÐÝ");
DEFINE("_RSGALLERY_MY_IMAGES_EDIT",			"ÊÚÏíá");
DEFINE("_RSGALLERY_MY_IMAGES_PERMISSIONS",	"ÓãÇÍíÇÊ");
...
DEFINE("_RSGALLERY_MY_IMAGES",				"ÕæÑí");
DEFINE("_RSGALLERY_MY_IMAGES_NAME",			"ÇáÇÓã");
DEFINE("_RSGALLERY_NOIMG_USER",				"æáÇ ÕæÑÉ Ýí ãÚÑÖ ÇáãÓÊÎÏã");
//function RSGalleryUserInfo
DEFINE("_RSGALLERY_USER_INFO",				"ãÚáæãÇÊ ÇáÕæÑÉ");
DEFINE("_RSGALLERY_USER_INFO_NAME",			"ÇÓã ÇáãÓÊÎÏã");
DEFINE("_RSGALLERY_USER_INFO_ACL",			"ãÓÊæì ÇáãÓÊÎÏã");
DEFINE("_RSGALLERY_USER_INFO_MAX_GAL",		"ÚÏÏ ãÓÊÎÏãí ÇáãÚÑÖ ÇáÃÚÙãí");
DEFINE("_RSGALLERY_USER_INFO_CREATED",				"Êã ÇäÔÇÁå)");
DEFINE("_RSGALLERY_USER_INFO_MAX_IMG",		"ÇáÚÏÏ ÇáÃÚÙãí ááÕæÑ ÇáãÊÇÍÉ");
DEFINE("_RSGALLERY_USER_INFO_UPL",			"Êã ÊÍãíáå)");
//function myGalleries
DEFINE("_RSGALLERY_USERGAL_DISABLED",		"User galleries was disabled by the administrator.");
//function showRandom
DEFINE("_RSGALLERY_RANDOM_TITLE",			"ÕæÑ ÚÔæÇÆíÉ");
//function showLatest
DEFINE("_RSGALLERY_LATEST_TITLE",			"ÂÎÑ ÇáÕæÑ");

//rsgallery2.php
//function my_galleries
DEFINE("_RSGALLERY_NO_USERCATS",            "ãÚÇÑÖ ÇáãÓÊÎÏãíä Êã ÊÕÝÍåÇ ãä ÞÈá ÇáãÏãíÑ");
DEFINE("_RSGALLERY_MYGAL_NOT_AUTH",			"ÚãáíÉ æÕæá ÛíÑ ãÎæáÉ Åáì ãÚÑÖí!");
//function save_image
DEFINE("_RSGALLERY_SAVE_SUCCESS",		    "Êã ÍÝÙ ÇáÊÝÇÕíá ÈäÌÇÍ");
DEFINE("_RSGALLERY_ERROR_SAVE",				"ÎØÃ: ");
...
DEFINE("_RSGALLERY_LICENSE",				"License");
//Cpanel
...
DEFINE("_RSGALLERY_BATCH_TITLE",		"Title");
...
/*new*/DEFINE("_RSGALLERY_CONF_LIMIT_NEV",		"Never");
/*new*/DEFINE("_RSGALLERY_CONF_LIMIT_LIMIT",	"If more galleries than limit");
/*new*/DEFINE("_RSGALLERY_CONF_LIMIT_ALW",		"Always");
...
/*new*/DEFINE("_RSGALLERY_STATUS_NOT_PUBL",		"This gallery is NOT published");
...
DEFINE("_RSGALLERY_SLIDE_START",		"ÈÏÁ");
DEFINE("_RSGALLERY_SLIDE_STOP",			"ÊæÞÝ");
DEFINE("_RSGALLERY_SLIDE_NEXT",			"ÇáÊÇáí");
DEFINE("_RSGALLERY_SLIDE_PREV",			"ÇáÓÇÈÞ");
...
DEFINE("_RSGALLERY_IMG_UPLOAD",			"ÊÍãíá");
DEFINE("_RSGALLERY_IMG_UPL_DETAILS",			"ÊÍãíá ÊÝÇÕíá");
DEFINE("_RSGALLERY_IMG_UPL_GALLERY",			"ÊÍãíá ãÚÑÖ");
DEFINE("_RSGALLERY_IMG_GEN_DESCR",			"æÕÝ ÚÇã");
DEFINE("_RSGALLERY_IMG_IMG_FILES",			"ãáÝÇÊ ÇáÕæÑ");
DEFINE("_RSGALLERY_IMG_IMAGES",			"ÕæÑ");
DEFINE("_RSGALLERY_IMG_FILE",			"ãáÝ");
DEFINE("_RSGALLERY_IMG_MORE",			"(ÕæÑÉ ÅÖÇÝíÉ)");
...
/*new*/DEFINE("_RSGALLERY_TMPL_GAL_DETAILS_OWNER",	"ÇáãÇáß: ");
/*new*/DEFINE("_RSGALLERY_TMPL_GAL_DETAILS_SIZE",	"ÇáÍÌã: ");
/*new*/DEFINE("_RSGALLERY_TMPL_GAL_DETAILS_DATE",	"Êã ÇáÇäÔÇÁ: ");
?>