...
DEFINE("_RSGALLERY_USERIMAGE_NOTOWNER",		"Nem Ön a tulajdonosa ennek a képnek, visszairányítjuk a fõoldalra");
...
DEFINE("_RSGALLERY_MAX_USERCAT_ALERT",		"Már létrehozta az engedélyezett számú galériát, visszairányítjuk a fõoldalra");
...
//function viewImages
DEFINE("_RSGALLERY_NO_PREVIEW ",		    "A képet nem tekintheti meg elõnézetben");
...
DEFINE("_RSGALLERY_SEL_TO_DEL",		"Jelölje ki a törlendõ elemeket a listában");
DEFINE("_RSGALLERY_SURE_DEL",		"Biztosan törölni akarja a kijelölt elemeket? ");
DEFINE("_RSGALLERY_SEL_TO_MOVE",		"Jelölje ki az áthelyezendõ elemeket a listában");
...
DEFINE("_RSGALLERY_EDITCSS_FAIL_NOOPEN",	"Sikertelen mûvelet: Nem nyitható meg a fájl: ");
...
DEFINE("_RSGALLERY_STATUS_ARE_OWNER",	"Ön a tulajdonosa ennek a galériának");
DEFINE("_RSGALLERY_STATUS_CAN_UPLOAD",	"Ön tölthet fel ebbe a galériába");
...
DEFINE("_RSGALLERY_INSTALL_SUCCESS",		"Sikerült!  Most már a következõ verziót használja: RSGallery2 ");
...
DEFINE("_RSGALLERY_GAL_DEF_PERM_CREATE",	"Az alapértelmezett engedélyek létrehozása kész. <br />A galéria létrehozása után térhet vissza a galéria engedélyeinek módosításához.");
DEFINE("_RSGALLERY_GAL_NO_PERM_FOUND",	"Nem találhatók ennek a galériának az engedélyei. Kattintson a <strong>MENTÉS</strong> gombra a fenti eszköztáron az alapértelmezett engedélyek létrehozásához. Ezután térjen vissza ide, és állítsa be az engedélyeket.");
...
DEFINE("_RSGALLERY_ACL_NO_PERM_FOUND",			"Nem található engedély, ezért az alapértelmezett engedélyek kerültek létrehozásra. Kérjük, hogy próbálja újra.");
...
DEFINE("_RSGALLERY_FU_PLEASE_CHECK_PATH",		"könyvárban. Ellenõrizze az elérési utat.");
...
DEFINE("_RSGALLERY_COMMENT_DELETE",	"Biztosan törölni akarja a véleményt?");
...
DEFINE("_RSGALLERY_COMMENTS_SEC_IMG_MISS", "Az adminisztrációban engedélyezték a SecurityImages bõvítményt, viszont nem történt meg a komponens telepítése! Értesítse a webmestert");
...
/*double deleted DEFINE("_RSGALLERY_COMMENTS_ONLY_ONCE",		"Csak egyszer nyilváníthat véleményt errõl a képrõl!");*/
DEFINE("_RSGALLERY_COMMENTS_INCORRECT_CAPTCHA",		"Helytelen CAPTCHA ellenõrzés, a véleményét NEM mentettük!");
...
//rsgvoting.class.php
DEFINE("_RSGALLERY_VOTING_ARE_YOU_SURE",		"Biztos, hogy akarja értékelni a képet?");
...
DEFINE("_RSGALLERY_VOTING_NOT_AUTH",		"Az értékelés az Ön számára nem engedélyezett!");
DEFINE("_RSGALLERY_VOTING_ALREADY_VOTED",		"Ön értékelte már ezt a képet!");
